...
public class SettingsScreen implements Screen {
    private final List<SettingsButtonTypes> buttons;
     ...
     */
    public SettingsScreen(NimasiJumper game) {
        this.game = game;
...
//                        }
     ...
     */
    private static final boolean isButtonActive(SettingsButtonTypes button) {
